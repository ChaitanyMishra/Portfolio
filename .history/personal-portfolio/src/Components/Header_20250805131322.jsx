export default function Header() {
  return (
    <header className="w-full h-auto flex items-center p-6 justify-evenly bg-white/10 backdrop-blur-md shadow-md rounded-b-2xl border-b border-white/20">
      ...
      >
        <span className="bg-gradient-to-r from-white via-violet-600 to-white bg-[length:200%_100%] bg-clip-text text-transparent group-hover:animate-shine transition-all duration-55700">
          Chaitany Mishra
        </span>
