  ...
  return (
    <header className="w-full h-auto flex items-center p-6 justify-evenly bg-white/10 backdrop-blur-md shadow-md rounded-b-2xl border-b border-white/20">
      ...
      >
        ...
        <span className="absolute bottom-0 left-0 h-[2px] w-0 bg-violet-100 group-hover:w-full transition-all duration-500"></span>
      </a>
      ...
      <nav className="mt-1">
        <ul className="flex text-violet-200 text-lg gap-6 pt-2">
          {["Home", "About", "Education", "Projects", "Contacts"].map((item) => (
            ...
            >
              <span className="bg-gradient-to-r from-white via-violet-300 to-white bg-[length:200%_100%] bg-clip-text text-transparent group-hover:animate-shine transition-all duration-700">
                {item}
              </span>
