...
export default function Header() {
  ...
  return (
    <header className="w-full h-auto pr-5 flex items-center p-6 justify-between bg-white/10 backdrop-blur-md shadow-md rounded-b-2xl border-b border-white/20">
