...
const FooterCanvas = () => {
  ...
  useEffect(() => {
    ...
    const resize = () => {
      canvas.width = window.innerWidth;git
...
const Footer = () => {
  return (
    <motion.footer
      ...
      viewport={{ once: true }}
      className="relative rounded-lg w-full py-12 text-center overflow-hidden bg-gradient-to-br from-indigo-800 to-indigo-900 text-white/90 border-t border-slate-200/10 shadow-lg"
    >
