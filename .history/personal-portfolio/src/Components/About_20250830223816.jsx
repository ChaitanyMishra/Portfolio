...
export default function About() {
  return (
  <section id="home" className="min-h-[60vh] flex flex-col md:flex-row items-center justify-center gap-12 py-20 px-6">
      <motion.div
      ...
      >
          ...
          <img
            src="/chaitany.jpg"
            alt="Profile"
            className="w-48 h-48 rounded-full object-cover border-4 border-indigo-500 shadow-lg transition-all duration-300"
          />
        </Tilt>
      </motion.div>
      <motion.div
