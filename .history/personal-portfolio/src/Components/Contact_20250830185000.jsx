  ...
  return (
    <section className="py-20 px-6 bg-gradient-to-br from-zinc-900 via-indigo-900 to-purple-900">
      ...
      <div className="flex justify-center gap-8 mt-10">
        ...
        <a href="https://linkedin.com/in/chaitanymishra-dev-" target="_blank" rel="noopener noreferrer" className="text-3xl text-white hover:text-indigo-400 transition-colors duration-200 hover:shadow-[0_0_16px_#a78bfa]">
          <SiLinkedin />
        </a>
