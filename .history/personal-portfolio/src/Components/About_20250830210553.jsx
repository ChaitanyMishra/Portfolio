...
export default function About() {
  return (
  <section className="min-h-[60vh] flex flex-col md:flex-row items-center justify-center gap-12 py-20 px-6 bg-[color:var(--background)]">
      <motion.div
      ...
      >
        <Tilt glareEnable={true} glareMaxOpacity={0.3} scale={1.05} className="rounded-full shadow-2xl">
          <img
            src="/chaitany.jpg"
            alt="Profile"
            className="w-48 h-48 rounded-full object-cover border-4 border-[color:var(--secondary)] shadow-lg hover:shadow-[0_10px_30px_rgba(236,72,153,0.12)] transition-all duration-300"
          />
        </Tilt>
      </motion.div>
      <motion.div
