    ...
    <footer className=' flex text-violet-200  bg-white/10 backdrop-blur-md shadow-md rounded-b-2xl border-b mt-6 border-x-white/20  '>
        <div className=" flex">
            <div className=" flex flex-col px-5 h-full py-5">
              <span className=" px-10 text-2xl font-serif sami-bold underline">Connect Online</span>
                <ul className="  flex flex-col justify-between items-center">
                  {[ "Email" ,"LinkedIn" , "Git Hub" ].map((item) =>(
                    <a key={item} href="#" className=" px-9 group relative font-medium overflow-hidden flex flex-col  ">
        ...
        <div>
        <p className=" absolute bottom-3 text-violet-200 text-base text-center w-full ">© 2025 Chaitany Mishra. All rights reserved.</p>
        </div>
    </footer>
  )
}
