                ...
                <ul>
                  {[ "Email" ,"LinkedIn" , "Git Hub" ].map((item) =>(
                    <a key={item} href="#" className="group relative font-medium overflow-hidden flex flex-col  ">
                      <span className="hover:px-3 hover:py-3 hover:rounded-lg hover:bg-violet-200 hover:text-violet-600 hover:my-3 hover:text-center transition-all duration-500 ">{item}</span> 
