...
const skills = [
  { title: 'HTML5', meta: 'Semantic markup, accessibility', icon: '🌐', color: 'from-orange-400 to-red-500', level: 'proficient' },
  { title: 'CSS3', meta: 'Flexbox, Grid, animations', icon: '🎨', color: 'from-blue-400 to-cyan-500', level: 'proficient' },
  { title: 'JavaScript', meta: 'ES6+, DOM, async programming', icon: '⚡', color: 'from-yellow-400 to-orange-500', level: 'proficient' },
  { title: 'React', meta: 'Hooks, Context, Router, State management', icon: '⚛️', color: 'from-cyan-400 to-blue-500', level: 'proficient' },
  { title: 'C/C++', meta: 'Data structures, algorithms', icon: '🔧', color: 'from-blue-500 to-indigo-600', level: 'proficient' },
  { title: 'Python', meta: 'Scripting, automation, data analysis', icon: '🐍', color: 'from-green-400 to-emerald-500', level: 'proficient' },
  { title: 'Java', meta: 'OOP, Spring framework basics', icon: '☕', color: 'from-orange-500 to-red-500', level: 'proficient' },
  { title: 'Git & GitHub', meta: 'Version control, collaboration', icon: '📚', color: 'from-gray-400 to-gray-600', level: 'proficient' },
  { title: 'SQL', meta: 'Database queries, relationships', icon: '🗄️', color: 'from-purple-400 to-pink-500', level: 'proficient' },
  { title: 'Tailwind CSS', meta: 'Utility-first, responsive design', icon: '💨', color: 'from-cyan-400 to-teal-500', level: 'proficient' },
              ...
              >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2">
                      <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                        ...
                        {skill.level === 'proficient' ? 'Proficient' : skill.level === 'intermediate' ? 'Intermediate' : 'Learning'}
                      </span>
                ...
                <div className="w-full bg-white/10 rounded-full h-2 mb-2">
                  <motion.div
                    ...
                    initial={{ width: 0 }}
                    whileInView={{ 
                      width: skill.level === 'proficient' ? '90%' : skill.level === 'intermediate' ? '60%' : '30%' 
                    }}
